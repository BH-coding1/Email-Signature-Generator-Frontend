...
const intergrationApps = [
  {
    ...
    description: "Easily apply and preview your signatures in Gmail with one click.",
  },
  {
    name: "Outlook",
    logo: "../../public/microsoft_office_outlook_logo_icon_145721.png",
    description: "Seamlessly sync signatures across Outlook desktop and web apps.",
  },
  {
    name: "Yahoo",
    logo: "../../public/1485482357-yahoo_78671.png",
    description: "Add professional signatures to your Yahoo Mail with quick setup.",
  },
  {
    name: "Airmail",
    logo: "../../public/Airmail.png",
    description: "Integrate signatures directly into Airmail for a smooth workflow.",
  },
];
            ...
            >
              <CardHeader className="flex ">
                <div className="h-20 w-20 flex items-center justify-center rounded-lg bg-gray-50 border">
                  <img src={app.logo} alt={app.name} className="h-12 object-contain" />
                </div>
              </CardHeader>

              <CardContent className=" space-y-2">
                <CardTitle className="text-lg font-semibold text-gray-900">{app.name}</CardTitle>
