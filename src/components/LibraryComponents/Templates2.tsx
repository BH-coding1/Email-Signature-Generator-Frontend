...
const TemplatesSidebar = () => {
  ...
  async function handleSelectTemplate(templateId: TemplateType) {
    try {
      if (!SignatureID) {
        throw new Error("SignatureID is required for saved signatures");
      }
      console.log("Selecting template:", { templateId, SignatureID });
      await setTemplate(templateId, SignatureID);
